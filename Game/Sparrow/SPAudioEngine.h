...
//extern NSString *const SPNotificationMasterVolumeChanged;
extern NSString *const SPNotificationAudioInteruptionBegan;
extern NSString *const SPNotificationAudioInteruptionEnded;
